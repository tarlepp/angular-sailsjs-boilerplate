/**
 * This file contains all necessary Angular model definitions for 'frontend.example.chat' module.
 *
        ...
        .factory('MessageModel',
            [
                ...
                function($sailsSocket,
                    ...
                    /**
                     * Sails socket action handlers. These are called whenever following event happens on current
                     * model:
                     *  - record is created
                     *  - record is updated
                     *  - record is deleted
                    ...
                    var model = {
                        ...
                        /**
                         * Service function to load message data from database and store those to current instance of
                         * service.
                         *
                         * @param   {{}}    [parameters]    Load parameters
                         *
                        ...
                        /**
                         * Service function to load single message data from database and store it to current instance
                         * of service.
                         *
