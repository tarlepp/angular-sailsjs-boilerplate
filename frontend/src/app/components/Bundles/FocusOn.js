/**
 * Generic 'focus' service for boilerplate application. Purpose of this component is to provide an easy way to trigger
...
(function() {
     ...
     */
    angular.module('frontend.components.bundles')
        .directive('focusOn',
            [
                '$timeout',
    ...
    angular.module('frontend.components.bundles')
        .factory('FocusOnService',
            [
                '$rootScope', '$timeout',
                function focusOnService($rootScope, $timeout) {
                    /**
